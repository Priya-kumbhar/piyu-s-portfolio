...
export const Timeline = ({ data }) => {
  ...
  return (
    ...
    <div ref={ref} className="relative pb-20">
     ...
     self-start max-w-xs md:flex-row 
     top-40 lg:max-w-sm md:w-full">
      <div className="absolute flex 
     items-center justify-center w-10 h-10 
    rounded-full -left-[15px]
     bg-midnight">
 <div className="w-4 h-4 p-2 border rounded-full
  bg-neutral-800 border-neutral-700" />
   </div>
 <div className="flex-col hidden gap-2 
 text-xl font-bold md:flex md:pl-20
  md:text-4xl text-neutral-300">
       <h3>
    {item.date}
     </h3>
...
<div className="relative w-full pl-20 pr-4 md:pl-4">
 ...
 <div style={{
     ...
     className="absolute md:left-1
      left-1 top-0 overflow-hidden w-[2px]
       ...
       from-transparent from-[0%] via-neutral-700
        ...
        black_90%,transparent_100%)] " >
    <motion.div
      style={{
           height: heightTransform,
              opacity: opacityTransform,
            }}   className="absolute inset-x-0
             top-0  w-[2px] bg-gradient-to-t
              from-purple-500 via-lavender/50 to-transparent
