...
<div className='flex flex-col space-y-6 md:hidden'>
    <motion.p className='text4xl font-medium '
             variants={variants}
             initial="hidden"
             animate="visible"
            transition={{delay:1}}
    
    > Hi , I'm Priyanka</motion.p>
  <div>
...
<motion.p className='text-4xl font-black text-neutral300'
             variants={variants}
             initial="hidden"
             animate="visible"
            transition={{delay:1.8}}>
